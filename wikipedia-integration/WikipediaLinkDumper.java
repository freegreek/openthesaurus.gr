 ...
 * Contains some filtering that is specific to Greek.
 * 
 ...
 * 
 * @author Daniel Naber
 * adapted to Greek wiktionary by Vasilis Kasimatis
 */
    ...
    class WikipediaPageHandler extends DefaultHandler {
        ...
        public void endElement(String namespaceURI, String sName, String qName) {
            if (qName.equals("title")) {
                ...
                final Set<String> links = extractLinks(text.toString());
for (String link : links) {
        ...
        private Set<String> extractLinks(String wikiText) {
            int pos = 0;
            ...
            while (true) {
                ...
                if (linkText.toLowerCase().startsWith("εικόνα:") || linkText.toLowerCase().startsWith("κατηγορία:") || linkText.toLowerCase().startsWith("αρχείο:")) {
                    continue;
                }
